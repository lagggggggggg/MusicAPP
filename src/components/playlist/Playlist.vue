      ...
      <div class="list-wrapper" @click.stop>
        ...
        <scroll ref="listContent"  class="list-content" :data="sequenceList">
          <transition-group name="list" tag="ul">
            <li  ref="listItem" class="item" v-for="(item,index) in sequenceList" :key="item.id" @click="seletcItem(item,index)">
              <i class="current" :class="getCurrentIndexIcon(item)"></i>
        ...
        <div class="list-operate">
          <div class="add" @click="showAddSong">
            <i class="icon-add"></i>
            <span class="text current-text">添加歌曲到队列</span>
          </div>
        </div>
